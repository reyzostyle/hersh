-- Exclude internal/test accounts from every admin dashboard metric — not
-- just the paying breakdown, but total users, signups, active users, etc.
-- These accounts don't represent real growth and would otherwise inflate
-- every number on the Growth tab.
...
DECLARE
  ...
  excluded_emails text[] := ARRAY['reyzostyle@gmail.com', 'julianpockl@gmail.com', 'qqnikitin@gmail.com'];
  excluded_ids uuid[];
BEGIN
