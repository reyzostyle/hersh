      ...
      >
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm">
            {emailSent ? 'Confirm your email to activate your account.' : mode === 'forgot' ? "We'll send you a reset link." : mode === 'login' ? 'Sign in to your Hersh account.' : 'No credit card required.'}
          </p>
        </div>
          ...
          <div className="text-center py-4 animate-fade-in">
            ...
            <div className="rounded-xl p-3 mb-5 text-left" style={{ background: 'rgba(14,164,233,0.08)', border: '1px solid rgba(14,164,233,0.2)' }}>
              <p className="text-[#0EA4E9] text-xs leading-relaxed">
                ⚠️ Open the link on <strong>this device</strong> — clicking it on your phone while Hersh is open on PC won't log you in here automatically.
              </p>
            </div>
            <button
